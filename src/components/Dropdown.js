...
const FontMenu = () => {
  ...
  return (
    <Menu as="div" className="relative inline-block text-left">
      ...
      >
        <Menu.Items className="absolute right-0 z-10 mt-2 origin-top-right rounded-md bg-white shadow-lg focus:outline-none whitespace-nowrap text-black w-32 cursor-pointer">
          <div className="py-1">
            <Menu.Item>
              <button
                onClick={() => {
